...
--
-- Host: localhost
-- Generation Time: Oct 29, 2015 at 10:16 AM
...
--
-- Table structure for table `beri_resep`
--
...
--
-- Dumping data for table `beri_resep`
--
...
--
-- Table structure for table `klevel`
--
...
CREATE TABLE IF NOT EXISTS `klevel` (
  ...
  PRIMARY KEY (`idlevel`),
  KEY `level` (`level`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 COMMENT='Kategori Level' AUTO_INCREMENT=8 ;

--
-- Dumping data for table `klevel`
--
...
--
-- Table structure for table `kmenu`
--
...
CREATE TABLE IF NOT EXISTS `kmenu` (
  ...
  KEY `level` (`level`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 COMMENT='Daftar kategori menu' AUTO_INCREMENT=16 ;

--
-- Dumping data for table `kmenu`
--
...
CREATE TABLE IF NOT EXISTS `lmenu` (
  ...
  KEY `kategori` (`kategori`),
  KEY `level` (`level`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 COMMENT='Daftar list menu' AUTO_INCREMENT=32 ;
...
(26, 'Perawat', 'Managemen', 'admin', 'main.php?id=perawat', 'zone-label.png'),
(27, 'Laporan Data Dokter', 'Laporan', 'kepala puskesmas', 'main.php?id=lap_data_dokter', 'zone-label.png'),
(28, 'Laporan Data Perawat', 'Laporan', 'kepala puskesmas', 'main.php?id=lap_data_perawat', 'zone-label.png'),
(29, 'Laporan Data Petugas Registrasi', 'Laporan', 'kepala puskesmas', 'main.php?id=lap_data_petugas_registrasi', 'zone-label.png'),
(30, 'Laporan Data Apoteker', 'Laporan', 'kepala puskesmas', 'main.php?id=lap_data_apoteker', 'zone-label.png'),
(31, 'Data Perawat', 'Laporan', 'admin', 'main.php?id=lap_data_perawat', 'zone-label.png');
...
CREATE TABLE IF NOT EXISTS `rekam_medis` (
  `idrekam_medik` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `uadmin` (
  ...
  PRIMARY KEY (`id`),
  KEY `level` (`level`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 COMMENT='Mangemen Data Admin' AUTO_INCREMENT=2 ;
...
--
-- Table structure for table `uapoteker`
--
...
--
-- Dumping data for table `uapoteker`
--
...
--
-- Table structure for table `udokter`
--
...
--
-- Dumping data for table `udokter`
--
...
--
-- Table structure for table `ukpl_puskesmas`
--
...
--
-- Dumping data for table `ukpl_puskesmas`
--
...
--
-- Table structure for table `upasien`
--
...
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 COMMENT='Managemen Data Pasien' AUTO_INCREMENT=108 ;

--
-- Dumping data for table `upasien`
--
...
--
-- Table structure for table `uperawat`
--

CREATE TABLE IF NOT EXISTS `uperawat` (
  `nip` varchar(50) NOT NULL,
  `ttl` varchar(50) NOT NULL,
  `jenis_kelamin` varchar(50) NOT NULL,
  `alamat` varchar(50) NOT NULL,
  ...
  `img` varchar(50) NOT NULL,
  PRIMARY KEY (`nip`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='Managemen perawat';

--
-- Dumping data for table `uperawat`
--

INSERT INTO `uperawat` (`nip`, `ttl`, `jenis_kelamin`, `alamat`, `no_telp`, `pendidikan`, `jabatan`, `agama`, `poli`, `status`, `img`) VALUES
('asda', 'asda', 'Wanita', 'sdasda', 'sdas', 'asd', 'asdasdda', 'kristen', 'Poli Kesehatan Ibu Dan Anak', 'tidak aktif', 'asda.jpg');

-- --------------------------------------------------------

--
-- Table structure for table `upetugas`
--
...
--
-- Dumping data for table `upetugas`
--
