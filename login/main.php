...
if (isset($_SESSION['level']))
{
  ...
  if ($_SESSION['level'] == "admin")
   { 
    include 'head.php';
    include 'sidebar.php';
    include 'controller/view/get_url_admin.php';
   //   include 'footer.php';
   }else if ($_SESSION['level'] == "dokter")
   {
      include 'head.php';
    include 'sidebar.php';
   include 'controller/view/get_url_dokter.php';
    // include 'conten_dokter.php';
   //  include 'footer.php';
   }else if ($_SESSION['level'] == "apoteker")
   {
      include 'head.php';
    include 'sidebar.php';
   include 'controller/view/get_url_apoteker.php';
   // include 'conten_petugas.php';
   //  include 'footer.php';
   }else if ($_SESSION['level'] == "petugas registrasi")
   {
      include 'head.php';
    include 'sidebar.php';
   include 'controller/view/get_url_petugas.php';
   // include 'conten_petugas.php';
   //  include 'footer.php';
   }else if ($_SESSION['level'] == "kepala puskesmas")
   {
      include 'head.php';
    include 'sidebar.php';
   include 'controller/view/get_url_kpl_puskesmas.php';
   // include 'conten_petugas.php';
   //  include 'footer.php';
   }else if ($_SESSION['level'] == "pasien")
   {
      include 'head.php';
    include 'sidebar.php';
   include 'controller/view/get_url_pasien.php';
   include 'controller/view/content_pasien.php';
   //  include 'footer.php';
   }
}
if (!isset($_SESSION['level']))
