    ...
    <section id="login-box">
        ...
        <p class="inline-small-label">
          ...
          <select class="inline-small-label" name="level">
            ...
            <option class="inline-small-label" value="admin">Administrator</option> 

            <option class="inline-small-label" value="dokter">Dokter</option> 

            <option class="inline-small-label" value="apoteker">Apoteker</option> 

            <option class="inline-small-label" value="petugas registrasi">Petugas</option>    
             <option class="inline-small-label" value="kepala puskesmas">Kepala Puskesmas</option>    
            </select>
        </p>
