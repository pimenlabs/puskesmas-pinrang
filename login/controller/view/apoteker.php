    ...
    <div id="title-bar">
      <ul id="breadcrumbs">
        ...
        <li class="no-hover"><b>Managemen apoteker </b></li>
      </ul>
      ...
      <div class="grid_12">
        <div class="block-border">
          <div class="block-header">
            <h1> <a href="main.php?id=tapoteker">Tambah User</a></h1> <span></span>
          </div>
           ...
           <table id="table-example" class="table">
              ...
              <tbody>
                ...
                <td><?php echo $puser['agama']; ?></td>
                  ...
                  <td><a href="main.php?id=eapoteker&nip=<?php echo $puser['nip']; ?>">Edit</a> 
                    | <a onclick="return confirm('Apakah anda yakin akan menghapus data ini?')" href="controller/delete/deletapoteker.php?dapoteker=<?php echo $puser['nip']; ?>">Hapus</a></td>
