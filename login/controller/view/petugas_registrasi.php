    ...
    <div id="title-bar">
      <ul id="breadcrumbs">
        ...
        <li class="no-hover"><b>Managemen Petugas Registrasi</b></li>
      </ul>
      ...
      <div class="grid_12">
        <div class="block-border">
          <div class="block-header">
            <h1> <a href="main.php?id=tpetugas">Tambah User</a></h1> <span></span>
          </div>
           ...
           <table id="table-example" class="table">
              ...
              <tbody>
                ...
                <td><?php echo $puser['agama']; ?></td>
                  ...
                  <td><a href="main.php?id=epetugas&nip=<?php echo $puser['nip']; ?>">Edit</a> 
                    | <a href="controller/delete/dpetugas.php?dpetugas=<?php echo $puser['nip']; ?>" onclick="return confirm('Apakah anda yakin akan menghapus data ini?')">Hapus</a></td>
