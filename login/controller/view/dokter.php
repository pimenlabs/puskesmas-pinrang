    ...
    <div id="title-bar">
      <ul id="breadcrumbs">
        ...
        <li class="no-hover"><b>Managemen Data Dokter</b></li>
      </ul>
      ...
      <div class="grid_12">
        <div class="block-border">
          <div class="block-header">
            <h1> <a href="main.php?id=tdokter">Tambah User</a></h1> <span></span>
          </div>
            ...
            <table id="table-example" class="table">
              ...
              <tbody>
                ...
                <td><?php echo $puser['spesialis']; ?></td>
                  ...
                  <td><a href="main.php?id=edokter&iddokter=<?php echo $puser['nip']; ?>">Edit</a> 
                    | <a onclick="return confirm('Apakah anda yakin akan menghapus data ini?')" href="controller/delete/ddokter.php?hdokter=<?php echo $puser['nip']; ?>">Hapus</a></td>
