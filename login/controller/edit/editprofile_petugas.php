 <?php  $kl = htmlspecialchars(mysql_real_escape_string($_GET['username'])); ?><!-- Begin of #main -->
    ...
    <div id="title-bar">
      <ul id="breadcrumbs">
        ...
        <li class="no-hover"><h2>Managemen petugas</h2></li>
      </ul>
      ...
      <div class="grid_12">
          ...
          <?php
           ...
           $alamat = htmlspecialchars(mysql_real_escape_string($_POST['alamat']));
            ...
            if (isset($_POST['id'])) {
              $insert = mysql_query("UPDATE upetugas SET username='$username',no_telp='$no_telp',
              jenis_kelamin='$jenis_kelamin',agama='$agama',alamat='$alamat',status='aktif',level='petugas registrasi',
...
copy($_FILES['img']['tmp_name'], "img/gambar/petugas/".$username.".jpg");
                ?>
    ...
    <div class="grid_12">
        <div class="block-border">
          <div class="block-header">
            <h1>Edit petugas | <a href="main.php?id=ubahpassword&username=<?php echo $_SESSION['username']; ?>&level=<?php echo $_SESSION['level']; ?>">Ubah Password</a></h1> 
