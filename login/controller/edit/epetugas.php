 ...
 <!-- Begin of #main -->
    ...
    <div id="title-bar">
      <ul id="breadcrumbs">
        ...
        <li class="no-hover"><h2><b>Managemen Data Petugas</b></h2></li>
      </ul>
      ...
      <div class="grid_12">
         ...
         <?php
           ...
           $status = htmlspecialchars(mysql_real_escape_string($_POST['status']));
            ...
            if (isset($_POST['nip'])) {
              $insert = mysql_query("UPDATE upetugas SET username = '$nama',
             ...
             // Simpan di Folder Gambar
              ...
              { copy($_FILES['img']['tmp_name'], "img/gambar/petugas/".$nip.".jpg");
    ...
    <div class="grid_12">
        <div class="block-border">
          ...
          <form id="validate-form" class="block-content form" action="" method="post" enctype="multipart/form-data">
           <?php 
$t = mysql_query("select * from upetugas where nip='$d'");
while ($r = mysql_fetch_array($t)) {
 ...
 <p>
            ...
            <p>
              ...
              <input type="text" name="level" value="petugas registrasi" hidden class="required">
            </p>
            <p>
              <label >Status</label>
            ...
            <p>
              <label >Gambar</label>  <img src="img\gambar\petugas\<?php echo $r['img']; ?>"><br>
