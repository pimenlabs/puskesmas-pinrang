    ...
    <div id="title-bar">
      <ul id="breadcrumbs">
        ...
        <li class="no-hover"><b>Managemen Laporan Persediaan Data Obat</b></li>
      </ul>
    ...
    <div id="main-content">
      ...
      <div class="grid_12">
        <div class="block-border">
            ...
            <h1> <a href="controller\report\cetak_laporan_persediaan_obat.php" target="_blank">Cetak Laporan</a></h1> <span></span>
          </div>
