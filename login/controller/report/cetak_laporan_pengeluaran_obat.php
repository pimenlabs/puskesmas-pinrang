...
<html>
<head>
	<title>Print Laporan Pengeluaran Data Obat</title>
...
<center>
    <h3>Laporan Data Pengeluaran Obat</h3>
      <h4>Dari Tanggal:
...
select *from obat_keluar WHERE tgl_keluar >= '$thn1-$bln1-$tgl1' AND tgl_keluar <= '$thn2-$bln2-$tgl2' 
                 ");
              $p=1;
              ...
              <?php } ?>  <tr>
              <?php 
                  $total = mysql_query("select sum(total) from obat_keluar WHERE tgl_keluar >= '$thn1-$bln1-$tgl1' AND tgl_keluar <= '$thn2-$bln2-$tgl2'" );
