    ...
    <div id="title-bar">
      <ul id="breadcrumbs">
        ...
        <li class="no-hover"><b>Managemen Laporan Kunjungan Pasien</b></li>
      </ul>
        ...
        <div class="block-border">
          <div class="block-header">
            <h1> 
              ...
              <a href="main.php?id=cetak_lap_kunjungan" >Cetak Laporan </a></h1> <span></span>
          </div>
          <div class="block-content">
            <table id="table-example" class="table">
              ...
              <tbody>
                <?php  $p=1;
                  $muser = mysql_query("select * from kunjungan");
