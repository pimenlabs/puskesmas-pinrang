 <!-- Begin of #main -->
    ...
    <div id="title-bar">
      <ul id="breadcrumbs">
        ...
        <li class="no-hover"><h2>Rekam Medis</h2></li>
      </ul>
    ...
    <div class="grid_12">
        ...
        <div class="block-border">
         <div class="block-header">
            ...
            Cetak Laporan </h1> <span></span>
          </div>
          <form id="validate-form" class="block-content form" action="controller\report\cetak_laporan_pengeluaran_obat.php" method="post">
         <br>
         <input name="kd_dokter" hidden value="<?php echo $_SESSION['username'] ?>">
