    ...
    <div id="title-bar">
      <ul id="breadcrumbs">
        ...
        <li class="no-hover"><b>Managemen Laporan Rekam Medis</b></li>
      </ul>
      ...
      <div class="grid_12">
        <div class="block-border">
          <div class="block-header">
            <h1> <a href="main.php?id=clap_rekam_medis">Cetak Laporan</a></h1> <span></span>
          </div>
...
<table id="table-example" class="table">
              ...
              <tbody>
                <?php 
                  $muser = mysql_query("select * from rekam_medis where kd_dokter = '".$_SESSION['username']."' and poli ='".$_SESSION['jenis_poli']."'");
