    ...
    <aside id="sidebar">
		...
		<section id="login-details">
          ...
          if ($_SESSION['level'] == 'admin') {
            ...
            ?>
            <img class="img-left framed" height="60" width="60" src="img/gambar/dokter/<?php echo $_SESSION['img']; ?>" alt="Hello Admin">
        <h2>Poli: <?php echo $_SESSION['jenis_poli']; ?></h2>
            <?php

            # code...
          }else if ($_SESSION['level'] == 'apoteker') {
            ?>
            <img class="img-left framed" height="60" width="60" src="img/gambar/apoteker/<?php echo $_SESSION['img']; ?>" alt="Hello Admin">
        
            <?php
            # code...
          }else if ($_SESSION['level'] == 'petugas registrasi') {
            ?>
            <img class="img-left framed" height="60" width="60" src="img/gambar/petugas/<?php echo $_SESSION['img']; ?>" alt="Hello Admin">
        
            <?php
            # code...
          }else if ($_SESSION['level'] == 'kepala puskesmas') {
            ?>
            <img class="img-left framed" height="60" width="60" src="img/gambar/kepala/<?php echo $_SESSION['img']; ?>" alt="Hello Admin">
        
            <?php
            # code...
          }else if ($_SESSION['level'] == 'pasien') {
            ?>
            <img class="img-left framed" height="60" width="60" src="img/gambar/pasien/<?php echo $_SESSION['img']; ?>" alt="Hello Admin">
